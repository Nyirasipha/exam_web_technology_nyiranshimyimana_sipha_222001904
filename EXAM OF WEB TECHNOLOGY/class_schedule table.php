...
<body>
    ...
    <div class="container">
        ...
        <h4 style="text-align: center; font-family: century; font-weight: bold;">LIST OF class_shedule FROM OUR platform</h4>
        <a href="class_shedule Form.html" class="btn btn-primary" style="margin-top: 0px;">New shedule</a>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td><a href='deleteclass_shedule.php?ScheduleID  =" . $row['ScheduleID '] . "'>Delete</a></td>
                                <td><a href='updateclass_shedule.php?ScheduleID =" . $row['ScheduleID '] . "'>update</a></td>
                              </tr>";
                    }
                } else {
